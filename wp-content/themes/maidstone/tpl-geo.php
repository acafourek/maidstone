...
*/
					...
					echo '<ul class="loc_list">';
						foreach($locations as $location){
							...
							echo '<li><a href="'.get_bloginfo('home').'/locations?loc='.$location->slug.'"><span class="map-icon"><i class="mg map-'.get_term_meta($location->term_id,'map_glyph',true).'"></i></span>'.$location->name.'</a></li>';
						}
					echo '</ul>';
				?>

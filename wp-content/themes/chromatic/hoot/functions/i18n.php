...
/* Overrides the load textdomain function for the 'chromatic' domain. */
...
/**
 * Overrides the load textdomain functionality when 'chromatic' is the domain in use.  The purpose of 
 * this is to allow theme translations to handle the framework's strings.  What this function does is 
 * sets the 'chromatic' domain's translations to the theme's.  That way, we're not loading multiple 

...
add_filter( 'chromaticfw_attr_body',    'chromaticfw_attr_body',    5    );
add_filter( 'chromaticfw_attr_header',  'chromaticfw_attr_header',  5    );
add_filter( 'chromaticfw_attr_footer',  'chromaticfw_attr_footer',  5    );
add_filter( 'chromaticfw_attr_content', 'chromaticfw_attr_content', 5    );
add_filter( 'chromaticfw_attr_sidebar', 'chromaticfw_attr_sidebar', 5, 2 );
add_filter( 'chromaticfw_attr_menu',    'chromaticfw_attr_menu',    5, 2 );

/* Header attributes. */
add_filter( 'chromaticfw_attr_site-title',       'chromaticfw_attr_site_title',       5 );
add_filter( 'chromaticfw_attr_site-description', 'chromaticfw_attr_site_description', 5 );

/* Loop attributes. */
add_filter( 'chromaticfw_attr_loop-meta',        'chromaticfw_attr_loop_meta',        5 );
add_filter( 'chromaticfw_attr_loop-title',       'chromaticfw_attr_loop_title',       5 );
add_filter( 'chromaticfw_attr_loop-description', 'chromaticfw_attr_loop_description', 5 );

/* Post-specific attributes. */
add_filter( 'chromaticfw_attr_post',            'chromaticfw_attr_post',            5    );
add_filter( 'chromaticfw_attr_entry',           'chromaticfw_attr_post',            5    ); // Alternate for "post".
add_filter( 'chromaticfw_attr_page',            'chromaticfw_attr_post',            5    ); // Alternate for "post".
add_filter( 'chromaticfw_attr_entry-title',     'chromaticfw_attr_entry_title',     5    );
add_filter( 'chromaticfw_attr_entry-author',    'chromaticfw_attr_entry_author',    5    );
add_filter( 'chromaticfw_attr_entry-published', 'chromaticfw_attr_entry_published', 5    );
add_filter( 'chromaticfw_attr_entry-content',   'chromaticfw_attr_entry_content',   5    );
add_filter( 'chromaticfw_attr_entry-summary',   'chromaticfw_attr_entry_summary',   5    );
add_filter( 'chromaticfw_attr_entry-terms',     'chromaticfw_attr_entry_terms',     5, 2 );

/* Comment specific attributes. */
add_filter( 'chromaticfw_attr_comment',           'chromaticfw_attr_comment',           5 );
add_filter( 'chromaticfw_attr_comment-author',    'chromaticfw_attr_comment_author',    5 );
add_filter( 'chromaticfw_attr_comment-published', 'chromaticfw_attr_comment_published', 5 );
add_filter( 'chromaticfw_attr_comment-permalink', 'chromaticfw_attr_comment_permalink', 5 );
add_filter( 'chromaticfw_attr_comment-content',   'chromaticfw_attr_comment_content',   5 );
 ...
 * @return void
 */
function chromaticfw_attr( $slug, $context = '', $class = '' ) {
	echo chromaticfw_get_attr( $slug, $context, $class );
}
 ...
 * @return string
 */
function chromaticfw_get_attr( $slug, $context = '', $classes = '' ) {

	$out    = '';
	$attr   = apply_filters( "chromaticfw_attr_{$slug}", array(), $context );
 ...
 * @return array
 */
function chromaticfw_attr_body( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_header( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_footer( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_content( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_sidebar( $attr, $context ) {
	...
	if ( !empty( $context ) ) {
		...
		$attr['aria-label'] = esc_attr( sprintf( _x( '%s Sidebar', 'sidebar aria label', 'chromatic' ), chromaticfw_get_sidebar_name( $context ) ) );
	}
 ...
 * @return array
 */
function chromaticfw_attr_menu( $attr, $context ) {
	...
	if ( !empty( $context ) ) {
		...
		$attr['aria-label'] = esc_attr( sprintf( _x( '%s Menu', 'nav menu aria label', 'chromatic' ), chromaticfw_get_menu_location_name( $context ) ) );
	}
 ...
 * @return array
 */
function chromaticfw_attr_site_title( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_site_description( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_loop_meta( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_loop_title( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_loop_description( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_post( $attr ) {
	...
	if ( !empty( $post ) ) {
		...
		elseif ( 'attachment' === get_post_type() && chromaticfw_attachment_is_audio() ) {

			$attr['itemtype'] = 'http://schema.org/AudioObject';
		}

		elseif ( 'attachment' === get_post_type() && chromaticfw_attachment_is_video() ) {
 ...
 * @return array
 */
function chromaticfw_attr_entry_title( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_entry_author( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_entry_content( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_entry_summary( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_entry_terms( $attr, $context ) {
 ...
 * @return array
 */
function chromaticfw_attr_comment( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_comment_author( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_comment_published( $attr ) {

	$attr['class']    = 'comment-published';
	$attr['datetime'] = get_comment_time( 'Y-m-d\TH:i:sP' );

	/* Translators: Comment date/time "title" attribute. */
	$attr['title']    = get_comment_time( _x( 'l, F j, Y, g:i a', 'comment time format', 'chromatic' ) );
 ...
 * @return array
 */
function chromaticfw_attr_comment_permalink( $attr ) {
 ...
 * @return array
 */
function chromaticfw_attr_comment_content( $attr ) {

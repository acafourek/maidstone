 ...
 * @since chromatic 1.2
 * @return array Return ChromaticFw Options array to be merged to the original Options array
 */

$chromaticfw_options_premium = array();

$chromaticfw_options_premium[] = array(
		'std' => sprintf( __("%1sUpgrade to Chromatic Premium%2sIf you've enjoyed using Chromatic, you're going to love Chromatic Premium. It's a robust upgrade to Chromatic that gives you useful features.", 'chromatic'), '<h4 class="heading">', '</h4>' ) );

$chromaticfw_options_premium[] = array(
		'name' => __('Complete Style Customization', 'chromatic'),
		'desc' => __('Chromatic Premium lets you select different colors for different sections of your site.<hr>Assign different typography (fonts, text size, font color) to menu, topbar, content headings, sidebar, footer etc.', 'chromatic'),
...
$chromaticfw_options_premium[] = array(
		'name' => __('Image Carousals', 'chromatic'),
		'desc' => __('Add carousals to your post, in your sidebar, on your frontpage or in your footer. A simple drag and drop interface allows you to easily create and manage carousals.', 'chromatic'),
...
$chromaticfw_options_premium[] = array(
		...
		'desc' => __('Moving to a new host? Easily import/export your admin panel settings with just a few clicks - right from the backend.', 'chromatic'),
		'img' => 'premium-import-export.jpg',
		);

$chromaticfw_options_premium[] = array(
		'std' => sprintf( __("%1sCustom Javascript &amp; Google Analytics%2sEasily insert any javascript snippet to your header without modifying the code files. This helps in adding scripts for Google Analytics, Adsense or any other custom code.", 'chromatic'), '<h4 class="heading">', '</h4>' ) );

$chromaticfw_options_premium[] = array(
		'std' => sprintf( __("%1sCustom CSS%2sAdd custom CSS to your theme right from the backend. If you are not a developer yourself, you can count on our support staff to help you with CSS snippets to get the look you're after. Best of all, your changes will persist across theme updates.", 'chromatic'), '<h4 class="heading">', '</h4>' ) );

$chromaticfw_options_premium[] = array(
		'std' => sprintf( __("%1sContinued Updates%2sYou'll help support the continued development of Chromatic - ensuring it works with future versions of WordPress for years to come.", 'chromatic'), '<h4 class="heading">', '</h4>' ) );

$chromaticfw_options_premium[] = array(
		'name' => __('Premium Priority Support', 'chromatic'),
		'desc' => __('Need help setting up Chromatic? Upgrading to Chromatic Premium gives you prioritized forum support. We have a growing support team ready to help you with your questions.', 'chromatic'),
...
return $chromaticfw_options_premium;
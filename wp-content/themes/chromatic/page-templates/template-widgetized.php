...
<div class="<?php echo $wt_content_grid; ?>">
				...
				if ( empty( $section[ 'sortitem_hide' ] ) ):
					...
					switch( $key ):
						...
						case 'area_a': case 'area_b': case 'area_c': case 'area_d': case 'area_e':
							?>
							<div id="widgetized-template-<?php echo sanitize_html_class( $key ); ?>" class="widgetized-template-area">
								<div class="grid">
									<?php
						...
						default:
							...
							do_action( 'widgetized_template_sections', $key, $sections );

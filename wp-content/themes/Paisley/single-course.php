<?php if(!defined('ABSPATH')) { exit; } get_header(); ?>
  ...
  <?php if(get_option('ace_lifterlms_course_width')) { echo '<main role="main" class="section-wide" id="section">'; } else { echo '<main role="main" class="section" id="section">'; } ?>
...
<?php if(!get_option('ace_lifterlms_course_width')) { get_sidebar(); } ?>
